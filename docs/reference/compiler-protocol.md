...
Runs completed before structural relation storage retain their earlier records and policy receipts. Compile a new run to apply relations from those responses.
