...
- live on-demand compiler work requires an accepted request for the same project, source version, run, compiler and version, model, and prompt digest before Merl records or dispatches it;
